...
<header>
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg navbar-light bg-white">
            <button class="navbar-toggler btn-left" type="button" data-toggle="collapse" data-target="#navbarMobile"
                    aria-controls="navbarMobile" aria-expanded="false" aria-label="Toggle navigation" id="navbarToggler">
            ...
            <div class="collapse navbar-collapse nav-fill w-100" id="nav-left">
                <ul class="nav navbar-nav nav-fill w-100">
                    <li class="nav-item">
                        <a class="nav-link active" href="login.php"><i class="far fa-user-circle"></i> Login</a>
                    </li>
