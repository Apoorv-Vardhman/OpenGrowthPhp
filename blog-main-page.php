                    ...
                    <div class="col-md-4 sm-mt-10 mt-5">
                        <div class="blog-single">
                            ...
                            <div class="blog-action d-flex justify-content-between mt-4">
                                ...
                                <div class="blog-share blog-action-text">
                                    <img src="assets/images/icons/view.svg" class="d-inline"> 4.6k
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row mt-5">
            <div class="col-md-6 sm-mt-10">
                <div class="blog-single">
                    ...
                    <h4 class="text-primary">Inspiring Diverse, Inclusive & Impact-driven Entrepreneurship</h4>
                    <p class="fs-15 fw-400">Lorem Ipsum is a very powerful application that runs online. There are virtually no platform boundaries when it comes to using figma because you can design within a web browser or using their desktop application made for windows and macs. Figma is similar to Sketch and Adobe XD but is the more powerful of the three when it comes to team collaboration and responsive, fast paced design.</p>
                    <div class="blog-action d-flex justify-content-between mt-4">
                        <div class="blog-share blog-action-text">
                    ...
                    <div class="row">
                        ...
                        <div class="col-9 col-sm-9 col-lg-9">
                            ...
                            <div class="blog-sidebar-action d-flex">
                                ...
                                <div class="col pl-1 pr-0">
                                    <span><i class="fas fa-comment"></i> 786 Comments </span>
                                </div>
                                <div class="col pl-1 pr-0">
...
<section class="section-blog-remain mb-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                <div class="blog-remain-container">
                    <div class="banner-blog-card  m-0">
                        <div class="row">
            ...
            <div class="col-lg-5" style="border-left: 2px solid #D0D0D0;">
                ...
                <?php
                    ...
                    { ?>
                        <div class="blog-sidebar">
                            <div class="row">
                                <div class="col-3">
                                    <img src="assets/images/blogs/blog3.png" class="h-100 br-12">
                                </div>
                                <div class="col-9">
