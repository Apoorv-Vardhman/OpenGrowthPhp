...
<section class="section-apply-process">
    <div class="container  br-t-1 br-b-1">
        ...
        <div class="row justify-content-center">
            <h1 class="heading-title text-primary">Why our mentors are unique</h1>
        </div>
                ...
                <div class="get-started">
                    <div class="row align-items-end mentorship-start">
                        ...
                        <div class="col-md-10">
                            ...
                            <p class="fs-14 fw-500 text-white">We are changing the mindsets of students and teaching them what it means to become an entrepreneur.</p>
